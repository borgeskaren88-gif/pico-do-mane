...
export function usuarios() {
  return [
    { id: 'u1', nome: process.env.USUARIO1_NOME || 'Karen', senha: process.env.USUARIO1_SENHA || '' },
    { id: 'u2', nome: process.env.USUARIO2_NOME || 'Mariele', senha: process.env.USUARIO2_SENHA || '' },
  ];
}
