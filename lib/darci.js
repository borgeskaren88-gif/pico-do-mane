...
export function alertas(n) {
  const a = [];
  const põe = (id, nivel, titulo, detalhe, pergunta) => a.push({ id, nivel, titulo, detalhe, pergunta });
  ...
  if (n.aReceberAgora > 0.005 && n.diaDoMes <= 10) {
    ...
    põe('fiado', 'atencao', `${brl(n.aReceberAgora)} de fiado pra receber`,
    ...
    põe('fiado', 'urgente', `${brl(n.aReceberAgora)} de fiado vencido`,
  ...
  if (n.previsao && n.previsao.dias) {
    põe('previsao', 'info', `Pra hoje eu espero ${brl(n.previsao.total)}`,
