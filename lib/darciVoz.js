...
export function textoParaFala(texto, nome) {
...
export function falarTexto(texto, { vozId, tom, nome, aoIniciar, aoTerminar } = {}) {
  if (!temVoz()) return;
  try {
    window.speechSynthesis.cancel();
    const u = new SpeechSynthesisUtterance(textoParaFala(texto, nome));
    u.lang = 'pt-BR';
